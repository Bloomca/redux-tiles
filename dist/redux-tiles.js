...
},{"./helpers":4,"lodash":21,"redux":28}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var helpers_1 = require("./helpers");
...
function ensureArray(value) {
    return lodash_1.isString(value) ? [value] : value;
}
...
function createReducer(initialState, handlers) {
    return createReducerFromObject(initialState, lodash_1.mapValues(handlers, function (value) { return function (state, action) { return reducerCreator({
        state: state,
        action: action,
        newValue: lodash_1.isFunction(value) ? value(state, action) : value
    }); }; }));
}
...
function reducerCreator(_a) {
    ...
    lodash_1.forEachRight(path, function (el, i) {
        var isLastItem = i === path.length - 1;
        var newNestedResult = (_a = {},
            _a[el] = isLastItem ? newValue : result,
            _a);
        lookupPath = path.slice(0, i);
        var oldState = lodash_1.get(state, lookupPath) || {};
...
},{"../helpers":4,"lodash":21}],11:[function(require,module,exports){
